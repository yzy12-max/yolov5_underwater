...
def run(data,
    ...
    print('Start Count Time. Start Count Time. Start Count Time.')
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/sonar.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='sonar_s6.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--project', default='/home/user7/Desktop/test_run_dir/', help='save to project/name')
    parser.add_argument('--name', default='sonar', help='save to project/name')
