...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='water_m6_last.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='optics', help='save to project/name')
